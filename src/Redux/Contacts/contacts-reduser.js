...
const contactItems = createReducer(InitialState, {
  [contactsActions.getContacts]: (state, { payload }) => ({
    ...state,
    items: [...payload],
  }),
  ...
  [contactsActions.fetchContactsRequest]: (state) => ({
    ...state,
    isLoading: true,
  }),
  [contactsActions.fetchContactsSuccess]: (state) => ({
    ...state,
    isLoading: false,
  }),
  [contactsActions.fetchContactsError]: (state, { payload }) => ({
    ...state,
    error: payload,
  }),
});
